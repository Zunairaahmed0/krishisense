...
function AnimatedCounter({ icon, label, value, suffix = "" }) {
  ...
  return (
    <div style={{ flex: 1, textAlign: "center", padding: "6px 4px" }}>
      ...
      <div style={{ fontSize: 22, fontWeight: 900, color: "#123C2C", lineHeight: 1 }}>
        {display.toLocaleString("en-IN")}{suffix}
      </div>
      <div style={{ fontSize: 9, color: "#82938A", fontWeight: 600, marginTop: 2 }}>{label}</div>
    </div>
  );
}
...
export default function HomeTab({
  ...
  return (
    <div style={{ paddingBottom: 16 }}>
      ...
      >
        <div style={{ minWidth: 0 }}>
          <div style={{ fontSize: 20, fontWeight: 800, color: C.txt }}>
            Good Morning, {user?.fullName || "Ramesh"}!{" "}
          ...
          >
            ...
            <span style={{ fontWeight: 700 }}>
              {loc
                ...
                : locError || "Detecting current location..."}
            </span>
          ...
          {loc && (
            ...
            >
              {loc.isManual ? "Manual override: " : "GPS coordinates: "}{" "}
          ...
          >
            ...
            <div style={{ flex: 1, textAlign: "left" }}>
              ...
              <div style={{ fontSize: 10, color: C.mut }}>
                ...
                {todayRain != null ? ` | Rain ${todayRain}%` : ""}
              </div>
              {(daily?.precipitation_probability_max?.[1] || 0) > 50 && (
                <div style={{ fontSize: 10, color: C.p3, fontWeight: 600 }}>
      ...
      {/* ── Impact Metrics ─────────────────────────────────── */}
      {scans.length > 0 && (
        <div style={{ margin: "0 14px 16px", borderRadius: 16, background: C.tint, border: "1px solid #C8E6C9", padding: "12px 8px" }}>
          <div style={{ fontSize: 10, fontWeight: 700, color: C.p2, textAlign: "center", marginBottom: 10 }}>
            📊 Your Farm Impact
          </div>
          <div style={{ display: "flex", borderTop: `1px solid #C8E6C9` }}>
            <AnimatedCounter icon="🛰" label="Total Scans"  value={scans.length} />
            <div style={{ width: 1, background: "#C8E6C9", margin: "8px 0" }} />
            <AnimatedCounter icon="💧" label="Water Saved"  value={Math.round(scans.filter(s => s.type === "soil").length * 3 * 8)} suffix=" kL" />
            <div style={{ width: 1, background: "#C8E6C9", margin: "8px 0" }} />
            <AnimatedCounter icon="🦠" label="Diseases Found" value={scans.filter(s => s.type === "leaf").length} />
          </div>
        </div>
      )}
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 24, textAlign: "right", marginTop: 4 }}>
            🧅
          </div>
        </div>
      ...
      <div style={{ margin: "0 14px 16px", display: "flex", gap: 10 }}>
        ...
        <Card
          style={{
            flex: 1,
            background: `linear-gradient(145deg, #FFF8F8, #FFEBEE)`,
        ...
        >
          ...
          <div style={{ fontSize: 10, color: C.txt2, fontWeight: 600 }}>
            Recommended Action
          </div>
          <div style={{ fontSize: 10, color: C.txt2 }}>
            Spray chlorothalonil within 48 hours.
          </div>
        </Card>
      </div>
      ...
      >
        {[
          ...
          },
          {
            ...
            val: "5 Days",
            sub: "Prices may increase by 10–12%",
            tint: C.tintAmb,
            border: "#FFE0B2",
          },
          {
            icon: "👥",
            label: "Nearby Buyer Match",
            val: "3 Buyers",
            sub: "Best price ₹19 – ₹20/kg",
            tint: "#EDE7F6",
            border: "#D1C4E9",
          },
        ].map((s, i) => (
          ...
          >
            ...
            <div style={{ fontSize: 9, color: C.mut, fontWeight: 600 }}>
              {s.label}
            </div>
            <div
              style={{
            ...
            <div style={{ fontSize: 9, color: C.mut, marginTop: 3 }}>
              {s.sub}
            </div>
          </div>
        ))}
